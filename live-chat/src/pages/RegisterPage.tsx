...
const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg-dark)" }}>
      ...
      {/* Background blobs */}
      <div
        className="fixed top-[-100px] right-[-100px] w-[400px] h-[400px] rounded-full opacity-20 blur-3xl pointer-events-none"
        style={{ background: "var(--accent-cyan)" }}
      />
      <div
        className="fixed bottom-[-100px] left-[-100px] w-[400px] h-[400px] rounded-full opacity-15 blur-3xl pointer-events-none"
